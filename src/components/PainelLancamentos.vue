  ...
  <div id="painelLancamento">
     <div id="formularioLancamento">
        <form @submit="salvar" >
            ...
            <input type="text" name="titulo" id="titulo" required v-model="titulo">
...
import {state, getters} from '../store/modules/lancamentos';
...
export default {
    ...
    methods: {
        ...
        salvar(event) {
            ...
            console.log(this.todosLancamentos)
        },
        limparFormulario(){
            this.titulo = "";
            this.descricao = "";
